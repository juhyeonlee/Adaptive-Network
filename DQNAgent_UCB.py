...
# with UCB algorithm - instead of epsilon greedy
...
class DQNAgent:
    ...
    def get_action(self, state):
        ...
        #else:
            # take greedy action
        bonus = self.ucb1.return_bonus()
        action_idx = np.argmax(q_value+bonus)
        self.ucb1.update(action_idx)
