...
if __name__ == '__main__':
    ...
    config_file = open('config/2.yaml', 'r')
    ...
    for ep in range(num_ep):
        ...
        for i in range(len(state) - 4):
            agent.append(DQNAgent(1, n_actions, action_space, args))
        ...
        # plt.show()
    with open('dqn_block4_var_nw' + str(args['nw_size']) + '_beta' + str(beta) + '_coeff' + str(args['utility_coeff']) + '.pkl', 'wb') as f:  # Python 3: open(..., 'wb')
