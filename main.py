...
if __name__ == '__main__':
    ...
    config_file = open('config/5.yaml', 'r')
    ...
    for ep in range(num_ep):
        ...
        # plt.show()
    with open('qtable_gamma0.1_200times6_more_var_nw' + str(args['nw_size']) + '_beta' + str(beta) + '_coeff' + str(args['utility_coeff']) + '.pkl', 'wb') as f:  # Python 3: open(..., 'wb')
