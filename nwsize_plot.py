...
total_energy = []
total_txr = []
with open('/home/jhlee/project/Adaptive-Network-exps/minhae_desktop/one_dim_5/var_nw5_beta0.0_dim_space[5]180207-082245.pkl', 'rb') as kk:
...
for c in range(len(nw_size)):
    ...
    # plt.show()
    plt.savefig('fig4_nw_goodput.eps')
    ...
    # plt.legend(handles=beta_patches)
    plt.legend(handles=nw_patches)
    plt.savefig('fig4_nw_energy.eps')
